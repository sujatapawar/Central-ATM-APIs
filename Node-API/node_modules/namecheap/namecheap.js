...
namecheap.prototype = {
  ...
  command: function(cmd, params, callback, method) {
    ...
    request(options, function(err, res, body) 
    {
      ...
      if(cmd=='domains.dns.getHosts')
      {
      res1 = body.ApiResponse.CommandResponse.DomainDNSGetHostsResult.host;
      err = err ? { code : err.Number, message: err.$t } : undefined;
      res = res ? res[Object.keys(res)[0]] : undefined;
     // console.log(res1);
      callback && callback(err, res1);
	}
	else
	{
		res = body.ApiResponse.CommandResponse.DomainDNSSetHostsResult;
      err = err ? { code : err.Number, message: err.$t } : undefined;
