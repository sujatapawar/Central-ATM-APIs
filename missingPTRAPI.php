...
if(isset($jsonString) and $jsonString!="")
{
   ...
   $obj->putAssetLog($missedPTRIP,1,"Req1=$obj->req1,IP=$AssignIP[0][IP],Pool Id=$Req1_Details[0][assigned_priority],Done by=ATM2");	
	...
	if($warmedUpIP !='')
    {
		...
		$obj->putAssetLog($warmedUpIP,1,"IP assigned to child-pool $childPoolId[0]","Req1=$obj->req1,Child-pool Id=$childPoolId[0],Reason=IP $AssignIP[0][IP] found with missing PTR,Done by=ATM2");  	
		}
   ...
   $obj->putAssetLog($missedPTRIP,1,"IP put into Available Assets","Req1=$obj->req1,Reason=IP $AssignIP[0][IP] found with missing PTR,Done by=ATM2");  	
